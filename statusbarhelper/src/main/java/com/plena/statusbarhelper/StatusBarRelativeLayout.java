...
public class StatusBarRelativeLayout extends RelativeLayout {
    ...
    public StatusBarRelativeLayout(Context context, AttributeSet attrs, int defStyle) {
    ...
    public void reSetPadding(Context context) {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.KITKAT) {
            ...
            setPadding(getPaddingLeft(), getPaddingTop() + actionBarHeight, getPaddingRight(), getPaddingBottom());
        }
    }
}
